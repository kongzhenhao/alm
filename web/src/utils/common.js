...
let translateInstanceStatus = (status) => {
  switch (status) {
    case 1:
      return i18n.t('message.waitingDispatch');
    case 2:
      return i18n.t('message.waitingWorkerReceive');
    case 3:
      return i18n.t('message.running');
    case 4:
      return i18n.t('message.failed');
    case 5:
      return i18n.t('message.success');
    case 9:
      return i18n.t('message.canceled');
    case 10:
      return i18n.t('message.stopped');
    default:
      return 'unknown';
  }
};
...
let translateWfInstanceStatus = (status) => {
  switch (status) {
    case 1:
      return i18n.t('message.wfWaiting');
    case 2:
      return i18n.t('message.running');
    case 3:
      return i18n.t('message.failed');
