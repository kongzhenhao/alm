...
const en = {
  message: {
    ...
    timeExpressionPlaceHolder:
      "Cron expression or number of millions for fixed_rate/fixed_delay job",
    executeConfig: "Execution config",
    javaProcessorInfoPLH: "Classname, eg: tech.powerjob.HelloWordProcessor",
    containerProcessorInfoPLH:
      "ContainerID#classname, eg: 1#tech.powerjob.HelloWordProcessor",
    ...
    designatedWorkerAddressPLH:
      "Empty for all workers; ip:port,ip:port for specific",
    ...
    ntfClickNoInstanceNode:
      "No instances have been generated, and details cannot be viewed!",
