<template>
  <div ref="power-job" class="power-job">
    <div class="power-job-header">
      <div class="job-tools">
        <div v-if="onClickImportNode" @click="onClickImportNode">
          <el-tooltip :content="$t('message.importJob')" effect="light" placement="top">
            <i class="el-icon-document-add"></i>
          </el-tooltip>
        </div>
        <div v-if="mode !== 'view'" @click="importJudgeNode">
          <el-tooltip :content="$t('message.condition')" effect="light" placement="top">
            <i class="iconfont icon-panduanti"></i>
            <!-- <img src="../assets/panduanti.png" alt="" width="16" height="16">  -->
          </el-tooltip>
        </div>
        <div v-if="mode !== 'view'" @click="importWorkflowNode">
          <el-tooltip :content="$t('message.workflowChild')" effect="light" placement="top">
        ...
        <div @click="handleZoomOut">
          <el-tooltip :content="$t('message.zoomOut')" effect="light" placement="top">
            <i class="el-icon-zoom-out"></i>
          </el-tooltip>
        </div>
        <div @click="handleZoomIn">
          <el-tooltip :content="$t('message.zoomIn')" effect="light" placement="top">
            <i class="el-icon-zoom-in"></i>
          </el-tooltip>
        </div>
        <div @click="handleAutoFit">
          <el-tooltip :content="$t('message.autoFit')" effect="light" placement="top">
            <i class="el-icon-aim"></i>
          </el-tooltip>
        </div>
        <div @click="fullScreen">
          <el-tooltip :content="$t('message.fullScreen')" effect="light" placement="top">
    ...
    <div class="power-job-body">
      <div ref="powerDag" :style="{ width: `${size.width}px` }" class="power-power-flow"></div>
      <div v-if="selectNode !== null" class="power-job-detail">
        <slot></slot>
      </div>
    </div>
  </div>
