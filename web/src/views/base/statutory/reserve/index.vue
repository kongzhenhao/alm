  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['base:statutory:reserve:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['base:statutory:reserve:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['base:statutory:reserve:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['base:statutory:reserve:export']"
        >导出</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleImport"
          v-hasPermi="['base:statutory:reserve:import']"
        >导入</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="700px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="法定/非单位准备金" prop="statutoryReserve">
              <el-input-number v-model="form.statutoryReserve" :precision="2" :step="1000" :min="0" @change="calculateTotal" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="法定准备金合计" prop="totalStatutoryReserve">
              <el-input-number v-model="form.totalStatutoryReserve" :precision="2" :step="1000" :min="0" :disabled="true" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
export default {
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/base/statutory/reserve/importData"
      }
    };
  },
  created() {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除法定准备金明细编号为"' + ids + '"的数据项？').then(() => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.$modal.confirm('是否确认导出所有法定准备金明细数据项？').then(() => {
        this.download('base/statutory/reserve/export', {
          ...this.queryParams
        }, `法定准备金明细_${new Date().getTime()}.xlsx`);
      });
    },
    /** 导入按钮操作 */
    handleImport() {
