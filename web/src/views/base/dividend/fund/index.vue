<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['base:dividend:fund:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['base:dividend:fund:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['base:dividend:fund:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['base:dividend:fund:export']"
        >导出</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleImport"
          v-hasPermi="['base:dividend:fund:import']"
        >导入</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="fundList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="投资收益率假设" align="center" prop="investmentReturnRate" width="120" />
      <el-table-column label="分红比例" align="center" prop="dividendRatio" width="100" />
      <el-table-column label="资金成本率T0" align="center" prop="fundCostRateT0" width="120" />
      <el-table-column label="资金成本率T1" align="center" prop="fundCostRateT1" width="120" />
      <el-table-column label="资金成本率T2" align="center" prop="fundCostRateT2" width="120" />
      <el-table-column label="资金成本率T3" align="center" prop="fundCostRateT3" width="120" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="700px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="投资收益率假设" prop="investmentReturnRate">
              <el-input-number v-model="form.investmentReturnRate" :precision="6" :step="0.001" :min="0" :max="1" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="分红比例" prop="dividendRatio">
              <el-input-number v-model="form.dividendRatio" :precision="6" :step="0.01" :min="0" :max="1" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
export default {
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/base/dividend/fund/importData"
      }
    };
  },
  created() {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除分红方案编号为"' + ids + '"的数据项？').then(() => {
        return delFund(ids);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.$modal.confirm('是否确认导出所有分红方案数据项？').then(() => {
        this.download('base/dividend/fund/export', {
          ...this.queryParams
        }, `分红方案_${new Date().getTime()}.xlsx`);
      });
    },
    /** 导入按钮操作 */
    handleImport() {
