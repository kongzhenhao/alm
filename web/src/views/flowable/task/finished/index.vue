    ...
    <el-table v-loading="loading" :data="finishedList" border @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <!-- <el-button size="mini" type="text" icon="el-icon-tickets" @click="handleRevoke(scope.row)">撤回 -->
          </el-button>
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    ...
    handleRevoke(row) {
      ...
      revokeProcess(params, row.tenantId).then(res => {
    ...
    //   this.$modal.confirm('是否确认删除流程定义编号为"' + ids + '"的数据项?', "警告", {
