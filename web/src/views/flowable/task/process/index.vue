...
<script>
import { delDeployment, exportDeployment } from '@/api/flowable/finished';
...
export default {
  ...
  methods: {
    ...
    resetQuery() {
      ...
      this.queryParams.tenantId = this.$route.query.isAll
        ? null
    ...
    handleStop(row) {
      ...
      stopProcess(params, row.tenantId).then((res) => {
